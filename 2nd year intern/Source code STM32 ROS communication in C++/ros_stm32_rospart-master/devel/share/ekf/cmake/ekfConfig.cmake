...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/jeff/Documents/test_sendmore/src/ekf_pose)
  set(ekf_DEVEL_PREFIX /home/jeff/Documents/test_sendmore/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/jeff/Documents/test_sendmore/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jeff/Documents/test_sendmore/src/ekf_pose/${idir}'.  ${_report}")
    endif()
